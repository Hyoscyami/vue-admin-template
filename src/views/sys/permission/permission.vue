      ...
      <el-col :span="18">
        <div class="filter-container">
          <el-form ref="formInline" :model="table.listQuery" :inline="true">
            <el-form-item label="权限名称" prop="code" @keyup.enter.native="searchFormSubmit">
              <el-input v-model="table.listQuery.name" placeholder="权限名称" />
            </el-form-item>
            <el-form-item label="菜单路径" prop="description">
              <el-input v-model="table.listQuery.path" placeholder="菜单路径" />
            </el-form-item>
...
<script>
import {add, del, getMaxSort, list, update} from '@/api/sys/permission'
